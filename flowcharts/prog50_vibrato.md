...
**53 words**, 12 class-A coefficient multiplies (2 named), 18 instructions still opaque. Landmarks detected: 2 LFO phase word(s), 2 envelope/damping word(s), 1 DRAM tap bracket(s), 2 waveshaper LUT selector(s).
...
flowchart TD
    ...
    N3 --> N4
    N5["Undecoded core<br/>18 of 53 instructions<br/>(hand-unrolled, straight-line &mdash; see the .dsm)"]
    N4 --> N5
