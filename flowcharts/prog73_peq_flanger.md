---
layout: page
title: "PEQ+FLANGER — signal-flow flowchart"
permalink: /effects-dsp/flowcharts/prog73_peq_flanger/
---
<!-- SYNCED from kn5000-roms-disasm dsp/flowcharts/prog73_peq_flanger.md by tools/sync_flowcharts.py -- DO NOT EDIT; run `make flowcharts`. -->

# PEQ+FLANGER &mdash; signal-flow flowchart
...
Image rep **algo 73** &middot; slots 73 &middot; **unit 0** (I-RAM load 84) &middot; family **combi** &middot; confidence **high**.
...
**UI parameters** (MEASURED, `notes/kn5000-dsp-paramlist.md`): BAND EMPHASIS FC, BAND EMPHASIS Q, BAND EMPHASIS G, FLANGER DRY/WET, DEPTH, LFO SPEED, RESONANCE, MANUAL, PHASE, LFO WAVEFORM, VOLUME, REV SEND.

Per-instruction detail: [`../disasm/prog73_peq_flanger.dsm`](https://github.com/ArqueologiaDigital/kn5000-roms-disasm/blob/main/dsp/disasm/prog73_peq_flanger.dsm). Confidence legend and method: [`README.md`]({{ site.baseurl }}/effects-dsp/flowcharts/). Narrative: the MAME development blog, KN5000 effects-DSP series (Parts 78-84). Reference: the project docs site, `/effects-dsp/`.
