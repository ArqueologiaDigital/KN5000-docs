---
layout: page
title: "Shared kernel — per-frame control flow"
permalink: /effects-dsp/flowcharts/kernel/
---
<!-- SYNCED from kn5000-roms-disasm dsp/flowcharts/kernel.md by tools/sync_flowcharts.py -- DO NOT EDIT; run `make flowcharts`. -->
...
Legend and method: [`README.md`]({{ site.baseurl }}/effects-dsp/flowcharts/). Narrative: the MAME development blog, KN5000 effects-DSP series (Parts 78-84).
