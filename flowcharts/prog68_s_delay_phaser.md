---
layout: page
title: "S.DELAY+PHASER — signal-flow flowchart"
permalink: /effects-dsp/flowcharts/prog68_s_delay_phaser/
---
<!-- SYNCED from kn5000-roms-disasm dsp/flowcharts/prog68_s_delay_phaser.md by tools/sync_flowcharts.py -- DO NOT EDIT; run `make flowcharts`. -->

# S.DELAY+PHASER &mdash; signal-flow flowchart
...
Image rep **algo 68** &middot; slots 68 &middot; **unit 0** (I-RAM load 84) &middot; family **combi** &middot; confidence **medium**.
...
flowchart TD
    ...
    N1 --> N2
    N3["controls: PHASER DRY/WET, DEPTH, LFO SPEED, RESONANCE, MANUAL, PHASE, LFO WAVEFORM"]
    N2 -.-> N3
    N4["All-pass / phaser chain<br/>2 marker(s); g&middot;d &plusmn; feedback (stage count OPEN)"]
    N2 --> N4
