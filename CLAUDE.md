...
Project issues are tracked centrally using [Beads](https://github.com/beads-ai/beads) in `/home/fsanches/compartilhado/kn5000_project/.beads/issues.jsonl`. Use `/home/fsanches/compartilhado/tools/bd` commands (never edit JSONL directly). The `issues.md` page is auto-generated — update via `cd /home/fsanches/compartilhado/kn5000-roms-disasm && make issues`, then commit the result here.
