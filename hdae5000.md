...
Four 320x240 8-bit grayscale images were extracted from the HDAE5000 ROM. These images are likely displayed on the connected PC during HD-TechManager5000 operations.

| Image | ROM Offset | Size | Description |
|-------|------------|------|-------------|
| [HDAE5000_Logo]({{ site.baseurl }}/image-gallery/#hd-ae5000-product-logo) | 0x28c00 | 76,800 bytes | Product logo with hard disk graphic |
| [HDAE5000_Hands]({{ site.baseurl }}/image-gallery/#hands-operating-hd-ae5000) | 0x3b800 | 76,800 bytes | Promotional image showing hands operating unit |
| [HDAE5000_FilePanel]({{ site.baseurl }}/image-gallery/#file-selection-panel) | 0x4e400 | 76,800 bytes | File selection UI with texture buttons |
| [HDAE5000_StartupScreen]({{ site.baseurl }}/image-gallery/#hd-ae5000-version-2-startup-screen) | 0x60400 | 76,800 bytes | Version 2 startup screen |

Total embedded image data: 307,200 bytes (~60% of the ROM).
...
| Embedded images | **100%** | 4 images extracted (307KB) |
