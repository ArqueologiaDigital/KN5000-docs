...
**Labels exposed: 29** | **Bytes disassembled: 949** (Boot_Init 236 + Alloc_Memory 45 + Get_Init_Flag 6 + Load_Palette 43 + Finalize_Init 1 + PPORT_Strings 560 + Frame_Handler_Exit 4 + Delay_Loop 17 + VGA_Port_Write 37)
