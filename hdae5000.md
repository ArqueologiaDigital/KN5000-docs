...
| 0x0F543-0x0F575 | 0x28F543 | 51B | Alloc_Memory routine |
...
| Code section 1 | **Labeled** | Split into 3 parts (Code_Section_1, Register_Frame, Alloc_Memory) |
| Frame handler | **Labeled** | Split into 4 parts (Frame_Handler, Clear_Work_Buffer, Load_Palette, Finalize_Init) |
...
**Labels exposed: 19** (all referenced routines now have proper labels)
