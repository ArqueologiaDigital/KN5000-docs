...
| Frame handler | **Labeled** | Split into 8 parts with utility routines |
...
**Labels exposed: 26** | **Bytes disassembled: 891** (Boot_Init 236 + Alloc_Memory 45 + Get_Init_Flag 6 + Load_Palette 43 + Finalize_Init 1 + PPORT_Strings 560)
