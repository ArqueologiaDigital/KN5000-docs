...
Total embedded image data: ~301KB (five images, including the boot-splash at 0x2E61CE) + 4KB (four 1,024-byte RGBX palettes at 0x2BB58E, 0x2CE58E, 0x2E158E and 0x2E5DCE).
...
| 0x2BA1A6-0x2BB58D | 0x2BA1A6 | 5,096B | Tail of Logo image pixel data (the 320×240 image starts at 0x2A898E) |
| 0x2BB58E-0x2BB98D | 0x2BB58E | 1,024B | RGBX palette (256 × 4B, 4th byte 0x00) |
| 0x2BB98E-0x2CE58D | 0x2BB98E | 76,800B | Hands image (320×240 8bpp indexed) |
| 0x2CE58E-0x2CE98D | 0x2CE58E | 1,024B | RGBX palette (256 × 4B) |
| 0x2CE98E-0x2E158D | 0x2CE98E | 76,800B | FilePanel image (320×240 8bpp indexed) |
| 0x2E158E-0x2E198D | 0x2E158E | 1,024B | RGBX palette (256 × 4B, halftone-style — the Icon palette) |
| 0x2E198E-0x2E1C81 | 0x2E198E | 756B | Icon image data (27×27 8bpp) |
| 0x2E1C82-0x2E5DCE | 0x2E1C82 | 16,716B | String data sections (config, test, dir, multilingual) |
| 0x2E5DCE-0x2E61CD | 0x2E5DCE | 1,024B | Main palette (a single 256 × 4B RGBX palette, not multiple) |
| 0x2E61CE-0x2F8DCD | 0x2E61CE | 76,800B | Boot-splash image (320×240 8bpp, previously unidentified; this is the pointer returned by `Alloc_Memory` at 0x28F543) |
...
| 0x2BA1A6 | HDAE5000_Font_Data | Misnomer — NOT font data: 8bpp indexed image data + RGBX palettes (Logo tail to 0x2BB58D, then palette/image pairs at 0x2BB58E, 0x2BB98E, 0x2CE58E, 0x2CE98E, 0x2E158E, 0x2E198E) |
