...
| 0x0F662-0x0F6DF | 0x28F662 | 126B | Frame_Handler - main entry, callback dispatch (LABEL) |
| 0x0F6E0-0x0F780 | 0x28F6E0 | 161B | Frame_Handler_Status - status check section (LABEL) |
...
| Frame_Handler | **Label exposed** | 126 bytes - main entry, callback dispatch |
| Frame_Handler_Status | **Label exposed** | 161 bytes - status check section |
...
**Labels exposed: 29** | **Bytes disassembled: 1,242** | **Binary files: 10 remaining**

Disassembled breakdown: Boot_Init 236 + Alloc_Memory 45 + Get_Init_Flag 6 + Load_Palette 43 + Finalize_Init 1 + PPORT_Strings 560 + Frame_Handler_Exit 4 + Delay_Loop 17 + VGA_Port_Write 37 + Clear_Work_Buffer 88 + Palette_Setup 205
