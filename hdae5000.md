...
| 0x0F785-0x0F812 | 0x28F785 | 142B | Clear_Work_Buffer, Delay_Loop, VGA_Port_Write |
...
| 0x28F7EE | HDAE5000_VGA_Port_Write | Write byte to VGA I/O port (mapped at 0x170000+port) |
...
| Frame handler | **Labeled** | Split into 5 parts with utility routines |
...
**Labels exposed: 21** | **Bytes disassembled: 330** (Boot_Init 236 + Alloc_Memory 45 + Get_Init_Flag 6 + Load_Palette 43)
