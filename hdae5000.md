...
**Labels exposed: 29** | **Bytes disassembled: 1,529** | **Binary files: 8 remaining**

Disassembled breakdown: Boot_Init 236 + Alloc_Memory 45 + Get_Init_Flag 6 + Load_Palette 43 + Finalize_Init 1 + PPORT_Strings 560 + Frame_Handler_Exit 4 + Delay_Loop 17 + VGA_Port_Write 37 + Clear_Work_Buffer 88 + Palette_Setup 205 + Frame_Handler 126 + Frame_Handler_Status 161
