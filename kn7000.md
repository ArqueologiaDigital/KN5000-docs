...
The **Technics SX-KN7000** (2002) is the successor to the [KN5000]({{ site.baseurl }}/system-overview/).
...
> common source lineage (see [Shared Codebase Map]({{ site.baseurl }}/technics-shared-codebase/)).
...
resource data (see the [Shared Codebase Map]({{ site.baseurl }}/technics-shared-codebase/)).
...
| Page | Description |
|------|-------------|
| [System Update Discs]({{ site.baseurl }}/kn7000-system-update-discs/) | `.SLD` container format, LZSS decompression, `.INF` checksum oracle, extraction tool |
| [Firmware Images]({{ site.baseurl }}/kn7000-firmware/) | Program & table flash layout, version numbers, string & hardware inventory, byte-exact disassembly project |
| [Image Gallery]({{ site.baseurl }}/kn7000-image-gallery/) | 169 images extracted from the firmware (demo slideshows, product photos, digital-drawbar UI graphics) |
| [User Data & Initial Data Disk]({{ site.baseurl }}/kn7000-initial-data/) | The custom-data flash (0x56000000/0x96800000), the Initial Data floppy (idd7000), Favorites/Memory/Home-Page install, and how the rhythm menu resolves style names |
| [Sound & Style Names]({{ site.baseurl }}/kn7000-sound-names/) | The complete inventory of 1,454 built-in voices + 931 accompaniment styles, extracted from the ROMs |
| [Shared Codebase Map]({{ site.baseurl }}/technics-shared-codebase/) | Where the KN5000 and KN7000 firmwares match |
